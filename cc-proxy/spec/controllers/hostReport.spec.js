...
function setNocks() {
	nockRaisely()
		...
		.get(`/events/${eventUuid}/rsvps?private=1`)
		.reply(200, {
		...
		.reply(200, {
			data: [
				{ userUuid: 'u1', talkativeness: 5, priority: 7, hope: 7, agency: 7 },
				{ userUuid: 'u2', talkativeness: 9, priority: 0, hope: 6, agency: 5 },
				{ userUuid: 'u4', priority: 4, hope: 1, agency: 0 },
				{ userUuid: 'u3', talkativeness: 5, priority: 4, hope: 0, agency: 0 },
			].map(toInteraction)
		})
		.get(
			`/interactions?category=post-category&private=1&reference=${eventUuid}`
		)
		.reply(200, {
			data: [
				{ userUuid: 'u1', host: false, talkativeness: 5, priority: 8, hope: 6, agency: 6, recommend: 9 },
				{ userUuid: 'u2', facilitate: true, volunteer: true, talkativeness: 8, agency: 7, priority: 10, hope: 7, recommend: 5 },
				{ userUuid: 'u3', volunteer: true, priority: 5, agency: 5, recommend: 0 },
				{ userUuid: 'u4', volunteer: true, talkativeness: 5, priority: 5, agency: 7 },
			].map(toInteraction)
		});
}
