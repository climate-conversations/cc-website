	...
	const badgeConfig = [
		{
			...
			active:
				"https://raisely-images.imgix.net/switchon/uploads/badge-switchon-2-png.png",
			inactive:
				"https://raisely-images.imgix.net/switchon/uploads/badge-switchon-1-png.png",
		...
		},
		{
			...
			// Images for active/inactive badge
			active:
				"https://raisely-images.imgix.net/switchon/uploads/badge-sharedmotivation-2-png.png",
			inactive:
				"https://raisely-images.imgix.net/switchon/uploads/badge-sharedmotivation-1-png.png",
		...
		},
		{
			...
			active:
				"https://raisely-images.imgix.net/switchon/uploads/badge-inspiration-2-png.png",
			inactive:
				"https://raisely-images.imgix.net/switchon/uploads/badge-inspiration-1-2-png.png",
		...
		},
		{
			...
			active:
				"https://raisely-images.imgix.net/switchon/uploads/badge-lungsaver-2-png.png",
			inactive:
				"https://raisely-images.imgix.net/switchon/uploads/badge-lungsaver-1-2-png.png",
	...
	return class BadgesComponent extends React.Component {
		...
		loadRecruits(profile) {
			...
			if (this.state.recruited === null) {
				fetch(
					`https://api.raisely.com/v3/profiles/${
						profile.uuid
					}/members?public.switchOnConfirmed=yes`
				)
		...
		render() {
			const profile =
				this.props.global.current.profile ||
				this.props.global.user.profile ||
				{};
			...
			values.badges =
				(values.badges &&
					values.badges.split(",").map(b => b.trim())) ||
			...
			const badges = badgeConfig
				...
				.map(badge => {
					let isActive = false;
					if (badge.isActive)
						isActive = badge.isActive(profile, this.state);
